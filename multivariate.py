...
# Dictionary for all paired crosses, which we analysed earlier.
combinations = {'app_type': ['is_commented_by_connections', 'is_liked_by_connections', 
...
for key in combinations.keys():
    ...
    for col_i in possible_col_i:
        ...
        for col_j in possible_col_j:
            ...
            g = sns.FacetGrid(predictor, col=key)
